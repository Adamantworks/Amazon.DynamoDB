...
namespace Adamantworks.Amazon.DynamoDB.Syntax
{
	public struct CompositeSyntax
	{
		...
		public CompositeSyntax(DynamoDBString hashKey)
		{
		...
		public static implicit operator ItemKey(CompositeSyntax value)
		{
			return new ItemKey(value.hashKey);
		}

		public static implicit operator DynamoDBString(CompositeSyntax value)
		{
