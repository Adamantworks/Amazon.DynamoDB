...
namespace Adamantworks.Amazon.DynamoDB
{
	public static class Composite
	{
		...
		{
			return Split<T1, T2>(value, DynamoDBValueConverter.CompositeValueDefault);
		}
		...
		{
			return Split<T1, T2, T3>(value, DynamoDBValueConverter.CompositeValueDefault);
		}
		...
		{
			return Split<T1, T2, T3, T4>(value, DynamoDBValueConverter.CompositeValueDefault);
		}
		...
		{
			return Split<T1, T2>(AsString(value), DynamoDBValueConverter.CompositeValueDefault);
		}
		...
		{
			return Split<T1, T2, T3>(AsString(value), DynamoDBValueConverter.CompositeValueDefault);
		}
		...
		{
			return Split<T1, T2, T3, T4>(AsString(value), DynamoDBValueConverter.CompositeValueDefault);
		}
