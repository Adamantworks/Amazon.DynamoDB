...
namespace Adamantworks.Amazon.DynamoDB.Contexts
{
	internal partial class IndexReadContext : IConsistentQuerySyntax
	{
		...
		public IndexReadContext(Index index, ProjectionExpression projection)
		{
			this.index = index;
			this.projection = projection;
		}
		public IndexReadContext(Index index, ProjectionExpression projection, bool consistentRead)
		{
			this.index = index;
			this.projection = projection;
