...
namespace Adamantworks.Amazon.DynamoDB.Contexts
{
	internal partial class TableReadContext : ITableFromSyntax, ITableConsistentSyntax
	{
		...
		public TableReadContext(Table table, ProjectionExpression projection)
		{
			this.table = table;
			this.projection = projection;
		}
		public TableReadContext(Table table, ProjectionExpression projection, bool consistentRead)
		{
			this.table = table;
			this.projection = projection;
